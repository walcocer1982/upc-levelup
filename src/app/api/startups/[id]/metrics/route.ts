...
export async function POST(
  ...
  try {
    ...
    const metricsData = {
      ...
      montoVentas: body.totalSalesAmount && body.totalSalesAmount !== "" ? parseInt(body.totalSalesAmount) : null,
      ...
      montoInversion: body.investmentAmount && body.investmentAmount !== "" ? parseInt(body.investmentAmount) : null,
